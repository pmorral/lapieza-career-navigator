            ...
            <>
              <Card className="shadow-card">
                <CardHeader>
                  ...
                  <CardDescription>
                    Sube cualquiera de tus CVs (LinkedIn o personal) y nuestra
                    IA generará contenido optimizado para tu perfil profesional.
                    ¡Solo necesitas 1 archivo para comenzar!
                  </CardDescription>
                </CardHeader>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="space-y-1 text-xs text-blue-800">
                              ...
                              <div className="flex items-start gap-2">
                                ...
                                <span>
                                  Busca el botón "Más" debajo de tu foto
                                </span>
                              </div>
                              <div className="flex items-start gap-2">
                          ...
                          exp.description.trim() && (
                            <div key={index} className="mb-4">
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <Button
                                  onClick={() =>
                                    copyToClipboard(exp.description)
                                  }
                                  variant="outline"
                                  size="sm"
                                >
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Button
                          onClick={() =>
                            copyToClipboard(
                              optimizedContent.english.projects ||
                                "Not available"
                            )
                          }
                          variant="outline"
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Button
                          onClick={() =>
                            copyToClipboard(
                              optimizedContent.english.interests ||
                                "Not available"
                            )
                          }
                          variant="outline"
                          ...
                          <div className="border-t bg-gray-50 p-4">
                            <div className="space-y-6">
                              ...
                              <div className="space-y-4">
                                ...
                                {/* Headline Español */}
                                {item.optimized_content.spanish?.headline && (
                                  <div className="mb-4">
                                    <div className="flex items-center justify-between mb-2">
                                      <h4 className="font-medium">
                                        Título Profesional
                                      ...
                                      <Button
                                        onClick={() =>
                                          copyToClipboard(
                                            item.optimized_content.spanish
                                              .headline
                                          )
                                        }
                                        variant="outline"
                                ...
                                {/* Summary Español */}
                                {item.optimized_content.spanish?.summary && (
                                  <div className="mb-4">
                                    <div className="flex items-center justify-between mb-2">
                                      <h4 className="font-medium">
                                        Resumen Profesional
                                ...
                                {/* Experience Español */}
                                {item.optimized_content.spanish?.experiences &&
                                  item.optimized_content.spanish.experiences
                                    .length > 0 &&
                                  item.optimized_content.spanish.experiences.some(
                                    (exp) =>
                                      exp.description && exp.description.trim()
                                  ) &&
                                  item.optimized_content.spanish.experiences.map(
                                    (
                                      exp: {
                                        title: string;
                                        company: string;
                                ...
                                {/* Skills Español */}
                                {item.optimized_content.spanish?.skills &&
                                  item.optimized_content.spanish.skills.length >
                                    0 &&
                                  item.optimized_content.spanish.skills.some(
                                    (skill) => skill && skill.trim()
                                  ) && (
                                    <div>
                                      ...
                                      <div className="flex flex-wrap gap-2">
                                        {item.optimized_content.spanish.skills.map(
                                          (skill, index) =>
                                            skill &&
                                            skill.trim() && (
                                              <span
