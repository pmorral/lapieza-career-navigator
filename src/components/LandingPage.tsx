...
export function LandingPage() {
  ...
  const faqs = [
    {
      question:
        "¿Qué es el Programa de Empleabilidad 360 de Academy by LaPieza?",
      answer:
    ...
    {
      question:
        "¿Puedo contratar servicios adicionales dentro de la plataforma?",
      answer:
  ...
  const features = [
    {
      ...
      title: "CV Boost",
      description:
        "Optimización profesional de tu CV con feedback personalizado",
    },
    {
      icon: Users,
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <Collapsible
                key={index}
                className="bg-background rounded-xl shadow-md border border-primary/10 hover:border-primary/20 transition-all duration-300"
              >
