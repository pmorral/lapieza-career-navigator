...
export function CVBoost() {
  ...
  const downloadTemplate = async (template: any) => {
    try {
      console.log(
        "CVBoost - Download attempt starting for template:",
        template
      );
      ...
      console.log(
        "CVBoost - HEAD response headers:",
        Object.fromEntries(response.headers.entries())
      );

      if (!response.ok) {
        console.error(
          "CVBoost - HEAD request failed with status:",
          response.status
        );
        throw new Error(
      ...
      console.log(
        "CVBoost - File response headers:",
        Object.fromEntries(fileResponse.headers.entries())
      );

      if (!fileResponse.ok) {
        console.error(
          "CVBoost - File fetch failed with status:",
          fileResponse.status
        );
        throw new Error(
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    console.log(
                      "CVBoost - Preview attempt for template:",
                      template
                    );
                    ...
                    try {
                      ...
                      if (!opened) {
                        console.error(
                          "CVBoost - Failed to open new tab - popup blocked?"
                        );
                        toast({
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Secciones optimizadas listas para usar
            </p>
          </div>
          <Button
            variant="outline"
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-medium">
                  👤 Nombre + Headline + Datos de Contacto
                </h3>
                <Button
                  onClick={() =>
                    copyToClipboard(
                      currentResult.sections?.personal ||
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  onClick={() =>
                    copyToClipboard(
                      currentResult.sections?.summary ||
                        currentResult.improvedContent
                          .split("\n")
                          .slice(0, 5)
                          .join("\n")
                    )
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  onClick={() =>
                    copyToClipboard(
                      currentResult.sections?.experience ||
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-medium">
                  🚀 Proyectos (solo perfiles junior/transición)
                </h3>
                <Button
                  onClick={() =>
                    copyToClipboard(
                      currentResult.sections?.projects || "Proyectos destacados"
                    )
                  }
                  variant="outline"
                  size="sm"
              ...
              <Textarea
                value={
                  currentResult.sections?.projects ||
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  onClick={() =>
                    copyToClipboard(
                      currentResult.sections?.certifications ||
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  onClick={() =>
                    copyToClipboard(
                      currentResult.sections?.education ||
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  onClick={() =>
                    copyToClipboard(
                      currentResult.sections?.languages ||
            ...
            <div className="mt-6 p-4 bg-muted rounded-lg">
              ...
              <div className="text-sm text-muted-foreground space-y-1">
                ...
                <p>
                  • Puesto objetivo:{" "}
                  {currentResult.configApplied?.targetPosition}
                </p>
              </div>
            </div>
          </CardContent>
