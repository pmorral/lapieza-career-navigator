      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Tu membresía ha expirado. Reactiva tu cuenta para continuar
            accediendo a todas las herramientas.
          </p>
        </div>
        ...
        <Card className="shadow-card">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Continúa transformando tu carrera profesional con Academy by
              LaPieza
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button className="w-full" size="lg" onClick={onReactivate}>
